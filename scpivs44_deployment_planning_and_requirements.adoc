...
| VMware向けONTAPツール | SnapCenter Plug-in for VMware vSphereは、これを使用してvVolデータストア（VMwareの仮想ボリューム）を管理します。サポートされているバージョンについては、 https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp Interoperability Matrix Tool"^] 。 


| NetApp ONTAPストレージ向け Amazon FSxN | 9.10以上 
|===
サポートされているバージョンに関する最新情報については、 https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp Interoperability Matrix Tool"^] 。
